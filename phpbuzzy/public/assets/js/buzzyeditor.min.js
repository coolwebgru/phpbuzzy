var BuzzyEditor = function() {
 ...
 var t = function() {},
  e = function() {
   $(".lists-types a").on("click", function() {
    ...
    swal({
     ...
     return t === !1 ? !1 : "" === t ? (swal.showInputError(BuzzyEditorlang.lang_7), !1) : null == t.match(/\.(jpeg|jpg|gif|png)$/) ? (swal.showInputError(BuzzyEditorlang.lang_8), !1) : ("preview" == a ? o(t) : r(e, t), void swal({
      title: "",
      timer: 1
     }))
    })
  ...
  a = function() {
   ...
   "none" == $(".lists-types a.selected").attr("data-order") || 0 == $(".lists-types a.selected").length ? $(".ordering").addClass("noorder") : $(".ordering").removeClass("noorder");
   var e = $(".entry").length,
  ...
  i = function() {
   ...
   }), $('[data-type="assign"]').each(function(t) {
    var e = "",
     a = $(this).find(":checked").attr("data-co"),
     n = $(this).attr("data-acst");
    $(i).each(function(t, i) {
     var o = i.split("|");
     e = t == n ? e + '<option selected="selected" data-co="' + o[0] + '" value="' + t + '">Result: ' + o[1] + "</option>" : a == o[0] ? e + '<option selected="selected" data-co="' + o[0] + '" value="' + t + '">Result: ' + o[1] + "</option>" : e + '<option data-co="' + o[0] + '" value="' + t + '">Result: ' + o[1] + "</option>"
    }), $(this).replaceWith('<select class="getassignres" data-type="assign"><option data-co="0" value="">Assign a result</option>' + e + "</select>")
   })
  },
  n = function() {
  ...
  p = function() {
   $(".createfacebookpost").off("click").on("click", function() {
    var t = $(this),
     e = t.parent("div").find("input").val();
    if ("" == e) return swal(BuzzyEditorlang.lang_11, BuzzyEditorlang.lang_9, "warning"), !1;
  ...
  g = function() {
   $(".PostAction").off("click").on("click", function() {
    NProgress.inc(), App.initLoadingCaption("show");
    var t = [];
    if (0 == $(".entry").length) return swal(BuzzyEditorlang.lang_10), NProgress.done(!0), App.initLoadingCaption("hide"), !1;
    $(".entry").each(function(e, a) {
     ...
     var o = $(this).find('[data-type="body"]').first().val();
     (null == typeof o || "" == o || void 0 == o) && (o = null);
     var r = $(this).find('[data-type="image"]').first().val();
     (null == typeof r || "" == r || void 0 == r) && (r = null);
     var s = $(this).find('[data-type="video"]').first().val();
     (null == typeof s || "" == s || void 0 == s) && (s = null);
     var l = $(this).find('[data-type="source"]').first().val();
     if ((null == typeof l || "" == l || void 0 == l) && (l = null), "quizquestion" == i) {
      var d = $(this).find('[data-curtype="on"]').first().attr("data-query");
      (null == typeof d || "" == d || void 0 == d) && (d = null), t[e] = {
       type: i,
       title: n,
       body: o,
       source: l,
       image: r,
       listtype: d
      }, t[e].answers = [], $(a).find(".answer").each(function(a, i) {
       var n = $(this).attr("data-type");
       (null == typeof n || "" == n || void 0 == n) && (n = null);
       var o = $(this).find('[data-type="title"]').first().val();
       (null == typeof o || "" == o || void 0 == o) && (o = null);
       var r = $(this).find('[data-type="image"]').first().val();
       (null == typeof r || "" == r || void 0 == r) && (r = null);
       var s = $(this).find('[data-type="assign"]').first().val(); 
       (null == typeof s || "" == s || void 0 == s) && (s = null);
       var isc = $(this).find('[data-type="is_correct"]').is(':checked') ? 1 : 0;
       (null == typeof isc || "" == isc || void 0 == isc) && (isc = null), t[e].answers[a] = {
        type: n,
        title: o,
        image: r,
        assign: s,
      ...
      title: n,
      body: o
     } : "embed" == i || "tweet" == i || "facebookpost" == i || "instagram" == i || "soundcloud" == i ? t[e] = {
      type: i,
      title: n,
      body: o,
      source: l,
    ...
    var e = $(this).closest("form"),
     a = $(this).attr("data-post-t"),
     i = e.find(".question-post-form").attr("data-type"),
     n = e.attr("action"),
     o = e.find("input[name=_token]").val(),
     r = e.find("input[name=headline]").val(),
     s = e.find("textarea[name=description]").val(),
     y = e.find("input[name=tag_title]").val(),
     zy = e.find("input[name=POST_DOMAIN]").val(),
     xy = e.find("input[name=URL_FROM]").val(),
     z = e.find("input[name=order]").val(),
     l = e.find("select[name=category]").val(),
     d = e.find("select[name=pagination]").val(),
     c = e.find("input[name=thumb]").val(),
     u = e.find(".lists-types a.selected").attr("data-order");
    return (null == typeof u || "" == u || void 0 == u) && (u = null), $(".lists-types").length > 0 && 0 == $(".lists-types a.selected").length ? (swal("Cooise list type"), NProgress.done(!0), App.initLoadingCaption("hide"), !1) : $(".entry").length < parseInt(d) && 0 != d ? (swal(BuzzyEditorlang.lang_12), NProgress.done(!0), App.initLoadingCaption("hide"), !1) : void $.post(n, {
     datapostt: a,
     title: r,
     description: s,
     tag_title: y,
