...
$iconne="";$user_idne="Guest";
 ...
 <textarea name="comment_text" id="" cols="30" rows="10" placeholder="<?php if($CUSER=="OFF"){ echo $lang["COMMENT_LINK_2AXX"]; }else{ echo $lang["COMMENT_LINK_3A"];  } ?>" onclick="exyorum_text(this)"></textarea>
 <div class="alt">
