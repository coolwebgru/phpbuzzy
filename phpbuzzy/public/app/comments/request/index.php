...
function uyeregister($user_username,$user_email,$user_password,$social,$socialtype,$first_name,$last_name,$hometown,$gender,$birthday){
	...
	if (isset($_SESSION['oturumid'])){ 
					...
					$_SESSION['kimdir'] = $gelenz['usertype'];
...
$msg_type = $_POST["contenttype"]; 
	...
	if($kullniciid==""){
			$cevapyaniyazanunvancolor="";$cevapyaniyazanunvanyazi="";
				...
				if($_SESSION["kimdir"]==1){$cevapyaniyazanusertypecolor='class="admin"';$cevapyaniyazanusertypeyazi='<span class="tag admin">'.$lang["COMMENT_TIP_2C"].'</span>';}
				elseif($_SESSION["kimdir"]==5){$cevapyaniyazanusertypecolor='class="mod"';$cevapyaniyazanusertypeyazi='<span class="tag moderator">'.$lang["COMMENT_TIP_2D"].'</span>';}
...
$response['error'] = $lang["GENERAL_EXTRA_1"];
	...
	if ($user_idsa==$_SESSION["oturumid"] or $_SESSION["kimdir"]=="1") {
